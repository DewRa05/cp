...
const Hero = () => {
  return (
    ...
    >
      ...
      {/* Text Section */}
      <div className="flex-1 text-white text-center md:text-left z-10 max-w-lg lg:max-w-xl">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[3rem] font-bold mb-4 leading-snug">
          Solusi teknologi <br />
        ...
        <p className="mb-5 text-sm md:text-base text-white/90 max-w-md mx-auto md:mx-0">
      ...
      {/* Image Section */}
      <div className="relative flex-1 flex justify-center items-center w-full md:w-[750px] lg:w-[850px] xl:w-[900px] z-10">
