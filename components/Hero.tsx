...
const Hero = () => {
  return (
    ...
    >
      ...
      {/* Text Section */}
      <div className="flex-1 text-white text-center md:text-left z-10 max-w-lg lg:max-w-xl" data-aos="fade-right" data-aos-delay="200">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[3rem] font-bold mb-4 leading-snug" data-aos="fade-up" data-aos-delay="300">
          Solusi teknologi <br />
        ...
        <p className="mb-5 text-sm md:text-base text-white/90 max-w-md mx-auto md:mx-0" data-aos="fade-up" data-aos-delay="400">
      ...
      {/* Image Section */}
      <div className="relative flex-1 flex justify-center items-center w-full md:w-[750px] lg:w-[850px] xl:w-[900px] z-10" data-aos="fade-left" data-aos-delay="300">
        <div className="relative scale-[0.75] sm:scale-[0.85] md:scale-[0.95] lg:scale-[1] origin-center">
          ...
          <Image
            ...
            width={600}
            height={500}
            className="absolute w-[600px] -rotate-[5deg] right-[40%] top-[10%] z-10 translate-x-[80px]"
            data-aos="zoom-in"
            data-aos-delay="500"
          />
        </div>
